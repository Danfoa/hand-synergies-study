...
if __name__ == '__main__':
    ...
    # latent_dim = 2
    #
    # # Load autoencoder trained model
    ...
    #
    # print("EVAL loaded model:", vae.evaluate(X_test_scaled, X_test_scaled))
    # vae.load_weights("models/VAE-ld=2/VAE")
    # print("EVAL loaded model:", vae.evaluate(X_test_scaled, X_test_scaled))
    #
    ...
    # delta_mean = tf.keras.layers.Dense(latent_dim)(lstm_pred)
    # delta_log_var = tf.keras.layers.Dense(latent_dim)(lstm_pred)
    #
    # pred_mean = tf.math.add(z_mean, delta_mean)
    # pred_log_var = tf.math.log(tf.exp(z_log_var + delta_log_var))
    #
    # pred_latent_state = vae.encoder.sampling(pred_mean, pred_log_var)
    #
    # pred_joint_state = vae.decoder(pred_latent_state)
    #
